...
(function applyPendingUpdate() {
    const possibleMarkers = [
        ...
        path.join(__dirname, "dist", "nightcord", "nightcord-pending-update.json"),
        path.join(__dirname, "nightcord-pending-update.json"),
    ];
        ...
        for (const entry of fs.readdirSync(src, { withFileTypes: true })) {
            ...
            if (entry.isDirectory()) {
                ...
                try {
                    ...
                    console.warn("[Nightcord] Could not copy", srcPath, ":", e.message);
                }
            }
        }
    }
    ...
    try {
        ...
        console.log("[Nightcord] Pending update applied successfully.");
    } catch (e) {
        console.error("[Nightcord] Failed to apply pending update:", e.message);
    }
