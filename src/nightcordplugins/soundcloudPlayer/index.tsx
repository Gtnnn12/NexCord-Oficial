...
function findUrlInReactFiber(element: HTMLElement | null): string | null {
    ...
    if (key) {
        ...
        while (fiber && depth < 6) {
            ...
            if (props) {
                if (typeof props.href === "string" && props.href.includes("NexCord.st/listen")) return props.href;
                if (typeof props.url === "string" && props.url.includes("NexCord.st/listen")) return props.url;
                if (typeof props.button?.url === "string" && props.button.url.includes("NexCord.st/listen")) return props.button.url;
            }
            fiber = fiber.return;
            depth++;
        }
...
export default definePlugin({
    ...
    start() {
        ...
        documentClickHandler = (e: MouseEvent) => {
            ...
            if (href && href.includes("NexCord.st/listen?")) {
                e.preventDefault();
                e.stopPropagation();
