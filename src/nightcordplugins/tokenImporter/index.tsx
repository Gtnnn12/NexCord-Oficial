            ...
            for (const acc of rawAccounts) {
                ...
                if (tok.startsWith("dQw4w9WgXcQ:")) {
                    try {
                        ...
                        console.error("[NexCord] decyption failed for ", acc.username, e);
                    }
                }
...
export default definePlugin({
    ...
    start() {
        addHeaderBarButton("NexCord-token-importer", () => <TokenImporterButton />, 10);
        getAccounts().then(async existing => {
            try {
    ...
    stop() {
        removeHeaderBarButton("NexCord-token-importer");
        accountsCache = null;
    },
});
