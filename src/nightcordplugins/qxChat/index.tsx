...
export default definePlugin({
    ...
    authors: [{ name: "NexCord User", id: 0n }],
    ...
    start() {
        ...
        FluxDispatcher.subscribe("NexCordNEWS_TOGGLE", handleOtherPluginToggle);
    },
    ...
    stop() {
        ...
        FluxDispatcher.unsubscribe("NexCordNEWS_TOGGLE", handleOtherPluginToggle);
    }
});
