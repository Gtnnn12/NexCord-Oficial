...
// through the cracks: window.__NexCordPCLReset()
...
export default definePlugin({
    ...
    authors: [{ name: "arg0NNY (ported by NexCord)",
     id: 0n }],
    settings,
    ...
    async start() {
        ...
        (window as any).__NexCordPCLReset = () => forceReset("manually triggered via window.__NexCordPCLReset()");
    ...
    stop() {
        ...
        clearTimeout(autolockTimeout);
        clearTimeout(watchdogTimeout);
        delete (window as any).__NexCordPCLReset;
