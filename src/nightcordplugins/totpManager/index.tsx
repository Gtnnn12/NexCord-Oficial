...
function TotpHeaderButton() {
    return (
        <HeaderBarButton
            ...
            tooltip={t("NexCord 2FA Authenticator")}
...
export default definePlugin({
    ...
    authors: [{ name: "NexCord Team", id: 999999999999999990n }],
    ...
    options: {
        showInHeader: {
            ...
            onChange(val: boolean) {
                if (val) {
                    addHeaderBarButton("NexCord-totp-btn", () => <TotpHeaderButton />, 8);
                } else {
                    removeHeaderBarButton("NexCord-totp-btn");
                }
            }
        }
    },
    ...
    commands: [
        {
            ...
            name: "2fa",
            description: "Open the integrated NexCord 2FA Authenticator",
            execute: async () => {
                openTotpModal();
            }
        },
