...
export function TotpSettingsPanel() {
    ...
    const handleExport = async () => {
        try {
            ...
            a.href = url;
            a.download = `NexCord_2fa_backup_${new Date().toISOString().slice(0, 10)}.json`;
            a.click();
                        ...
                        {accounts.length === 0 ? (
                            <div className="totp-empty-box">
                                ...
                                <Paragraph size="sm" color="text-muted" style={{ maxWidth: 360, textAlign: "center", marginBottom: 16 }}>
                                    {t("Store your 2FA authentication secret keys securely in NexCord and generate instant 6-digit verification codes.")}
                                </Paragraph>
