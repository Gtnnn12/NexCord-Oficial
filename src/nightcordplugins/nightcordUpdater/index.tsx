...
// Config
const REMOTE_VERSION_URL = `https://api.github.com/repos/Gtnnn12/NexCord-Oficial/releases/latest`;
...
async function checkForUpdates() {
    ...
    try {
        ...
        console.debug("[NexCordUpdater] Check skipped:", e?.message || e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.NexCord?.relaunch?.();
                } catch {
            ...
            console.error("[NexCordUpdater] Update error:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `NexCord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("NexCord-updater-root")) return;

    waitFor(["createRoot", "render"], (ReactDOM: any) => {
        if (bannerContainer || document.getElementById("NexCord-updater-root")) return;
        bannerContainer = document.createElement("div");
        bannerContainer.id = "NexCord-updater-root";
        ...
        try {
            ...
            console.error("[NexCordUpdater] Error mounting banner:", e);
...
export default definePlugin({
    ...
    required: true,
    description: "Shows a banner when a new NexCord version is available. Click Update to install.",
