                    ...
                    <div className={cl("modal-section")}>
                        ...
                        <div className={cl("modal-grid")}>
                            ...
                            {((event.type === "message" || event.type === "message_delete") && !event.content && !settings.store.captureMessageContent) ? (
                                <DetailField label={t("Message Content")} value={(document.documentElement.lang || "en-US").startsWith("fr") ? "[La capture du contenu des messages est d̩sactiv̩e dans les param̬tres de Surveillance]" : "[Message content capture is disabled in Surveillance settings]"} wide={true} preserve={true} />
                            ) : (
                            ...
                            {(event.type === "message_edit" && !event.before && !event.after && !settings.store.captureMessageContent) ? (
                                <>
                                    <DetailField label={t("Before")} value={(document.documentElement.lang || "en-US").startsWith("fr") ? "[La capture du contenu des messages est d̩sactiv̩e dans les param̬tres de Surveillance]" : "[Message content capture is disabled in Surveillance settings]"} wide={true} preserve={true} />
                                    <DetailField label={t("After")} value={(document.documentElement.lang || "en-US").startsWith("fr") ? "[La capture du contenu des messages est d̩sactiv̩e dans les param̬tres de Surveillance]" : "[Message content capture is disabled in Surveillance settings]"} wide={true} preserve={true} />
                                </>
                            ) : (
                                <>
