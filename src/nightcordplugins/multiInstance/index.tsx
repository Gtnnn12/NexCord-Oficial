...
export default definePlugin({
    ...
    async start() {
        ...
        addHeaderBarButton("NexCord-multi-instance", () => <MultiInstanceButton />, 9);
    },

    stop() {
        removeHeaderBarButton("NexCord-multi-instance");
        if (this._fluxUnsub) { this._fluxUnsub(); this._fluxUnsub = null; }
        const root = document.getElementById("NexCord-mi-ctx-root");
        if (root) root.remove();
    },
});
