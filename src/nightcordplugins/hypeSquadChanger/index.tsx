...
function injectHypeSquadChangerIntoNativePanel() {
    ...
    if (editingPanel && !document.getElementById("NexCord-hypesquad-changer-modal-container")) {
        const scroller = editingPanel.querySelector("[class*='content__523e1'], [class*='scroller_'], [class*='scrollRegion_'] > div");
        if (scroller) {
            const container = document.createElement("div");
            container.id = "NexCord-hypesquad-changer-modal-container";
    ...
    if (settingsView && !document.getElementById("NexCord-hypesquad-changer-container")) {
        ...
        if (isProfileTab) {
            ...
            if (contentColumn) {
                ...
                if (!targetParent.querySelector("#NexCord-hypesquad-changer-container")) {
                    const container = document.createElement("div");
                    container.id = "NexCord-hypesquad-changer-container";
...
function stopDomObserver() {
    ...
    for (const id of ["NexCord-hypesquad-changer-container", "NexCord-hypesquad-changer-modal-container"]) {
