...
const TABS: TabDef[] = [
    ...
    },
    {
        ...
        description: "Sync NexCord settings across devices",
    },
    {
        id: "language",
        label: "Language",
        ...
        description: "Change NexCord's interface language",
    },
];
...
function NightcordModalInner({ onClose }: { onClose: () => void; }) {
    ...
    let TabContent = null;
    switch (activeTab) {
        case "NexCord": TabContent = <VencordTab />; break;
    ...
    return (
        <ModalRoot {...modalProps} size={ModalSize.LARGE} className="nc-modal-wrapper">
            <ModalContent className="nc-modal-modal-content">
                <ErrorBoundary message="Failed to render NexCord Settings modal.">
