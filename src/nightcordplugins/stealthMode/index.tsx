...
export default definePlugin({
    ...
    description: "Hides all plugin buttons without disabling them. Shortcut: Ctrl+Shift+H. The toggle is in NexCord Settings.",
    ...
    stop() {
        document.body.classList.remove("NexCord-stealth");
    },
});
