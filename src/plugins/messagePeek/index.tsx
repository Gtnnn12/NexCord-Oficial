...
function MessagePreviewContent({ channel, user }: { channel: Channel; user: User | null | undefined; }) {
    ...
    if (channel.isSystemDM()) {
        const isNexCord = channel.id === "999999999999999990" ||
            channel.name?.toLowerCase().includes("NexCord") ||
            (channel.recipients && channel.recipients.includes("999999999999999999"));
        return isNexCord ? <>Official NexCord Message</> : <>Official Discord Message</>;
    }
