...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const fullEntries: SettingsLayoutNode[] = [
            ...
            buildEntry({
                ...
                panelTitle: "NexCord Sync",
                Component: SyncTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "NexCord_language",
                title: "Language",
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("NexCord_stealthMode") === "1") return ""; } catch { }
                return t("NexCord Settings");
            },
            buildLayout: () => {
                try { if (localStorage.getItem("NexCord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`NexCord ${gitHashShort}${getVersionInfo()}`];
