        ...
        <SettingsTab>
            ...
            <div className={Margins.bottom8}>
                <SafeSearchableSelect
                    ...
                    closeOnSelect={true}
                    renderOptionPrefix={o => o?.value?.includes("NexCord") ? <NexCordIcon /> : o?.value?.includes("equicord") ? <EquicordIcon /> : <VencordIcon />}
                />
            </div>
