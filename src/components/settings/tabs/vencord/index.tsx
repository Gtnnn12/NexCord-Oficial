    ...
    return (
        <>
            <QuickActionCard>
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="NexCord Channel"
                    action={() => (typeof VencordNative !== "undefined" && VencordNative?.native?.openExternal) ? VencordNative.native.openExternal("https://t.me/NexCordoff") : window.open("https://t.me/NexCordoff", "_blank")}
                />
            </QuickActionCard>
...
function useCompactActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("NexCord-compact-change", handler);
        return () => window.removeEventListener("NexCord-compact-change", handler);
    }, []);
    return active;
}
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("NexCord-stealth-change", handler);
        return () => window.removeEventListener("NexCord-stealth-change", handler);
    }, []);
    return active;
}
...
function MellowtelSupportSwitch() {
    ...
    return (
        <FormSwitch
            ...
            title={t("Share bandwidth to support NexCord (Mellowtel)")}
            description={
                consent
                    ? undefined
    ...
    const Switches: Array<false | {
        ...
        = [
            ...
            !IS_WEB && {
                ...
                description: t("Prevent NexCord from automatically checking, downloading, or prompting for updates on startup. You can still update manually in the \"Updater\" settings tab."),
                restartRequired: false,
                warning: { enabled: false },
            },
        ];
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    {t("Configure how NexCord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.")}
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    {t("Configure how NexCord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.")}
                </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Replaces all NexCord buttons with a single compact toggle icon. Click the icon in the header bar, channel toolbar, or chat bar to restore all buttons.")}
            </Paragraph>
            <Button
...
export default wrapTab(EquicordSettings, "NexCord Settings");
