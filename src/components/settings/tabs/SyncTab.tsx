...
const cloudBackendOptions = [
    { label: "NexCord Cloud", value: "https://api.NexCord.st/" },
...
const BADGE_OPTIONS: Array<{ label: string; value: BadgeSource }> = [
    { label: "NexCord Badges", value: "NexCord" },
...
function renderPrefix(option: { value: BadgeSource }) {
    switch (option.value) {
        case "NexCord": return <NexCordIcon />;
    ...
    return (
        <div style={{ marginBottom: 16 }}>
            <FormSwitch
                ...
                title={t("NexCord Sync")}
                description={isEnabled
                    ? t("Your custom profile is synced. Other NexCord users can see your profile, and you can see theirs.")
                    : t("Enable to share your custom profile with other NexCord users and see their profiles.")}
                disabled={busy}
            />
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {t("NexCord's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.")}
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                {t("We use our own NexCord Cloud backend with enhanced features.")}
                {" "}
            ...
            <div className={Margins.bottom8}>
                <SafeSearchableSelect
                    ...
                    renderOptionPrefix={o => {
                        if (o?.value?.includes("NexCord")) return <NexCordIcon />;
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Synchronize your NexCord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.")}
            </Paragraph>
