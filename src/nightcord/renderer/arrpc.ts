...
import { Logger } from "@NexCord/types/utils";
import { findLazy, onceReady } from "@NexCord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@NexCord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("NexCordRPC", "#5865f2");
