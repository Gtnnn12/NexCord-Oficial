...
import { Heading, Paragraph } from "@NexCord/types/components";
import { Margins } from "@NexCord/types/utils";
import { Select } from "@NexCord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind NexCord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
