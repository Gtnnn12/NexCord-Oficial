...
import { BaseText, Button, FormSwitch } from "@NexCord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@NexCord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`NexCord://assets/${asset}?v=${version}`}
                    alt=""
