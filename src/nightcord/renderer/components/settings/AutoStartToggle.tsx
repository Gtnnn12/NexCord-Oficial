...
import { useState } from "@NexCord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start NexCord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start NexCord minimized when starting with system"}
