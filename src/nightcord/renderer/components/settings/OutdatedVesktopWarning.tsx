...
import { Button, Card, HeadingTertiary, Paragraph } from "@NexCord/types/components";
import { useAwaiter } from "@NexCord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your NexCord is outdated!</HeadingTertiary>
