...
import { onceReady } from "@NexCord/types/webpack";
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@NexCord/types/webpack/common";
...
const logger = new Logger("NexCordScreenShare");
