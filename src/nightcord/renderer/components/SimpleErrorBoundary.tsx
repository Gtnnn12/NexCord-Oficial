...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@NexCord/types/components";
import { FluxDispatcher, InviteActions } from "@NexCord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure NexCord and NexCord are fully up to date. You can get help in our{" "}
