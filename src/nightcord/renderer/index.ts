...
VesktopLogger.log(`NexCord v${VesktopNative.app.getVersion()}`);

const { customEntries, customSections } = Vencord.Plugins.plugins.Settings as any as typeof SettingsPlugin;

customEntries.push({
    key: "NexCord_NexCord_settings",
    title: "NexCord Settings",
    Component: SettingsUi,
    Icon: VesktopSettingsIcon
});

customSections.push(() => ({
    section: "NexCordSettings",
    label: "NexCord Settings",
    element: SettingsUi,
    className: "vc-NexCord-settings"
}));
